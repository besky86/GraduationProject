...
public class User {
	...
	public static User getUserByJSON(JSONObject jsonObject) {
		...
		try {
			...
			user.setDescriprtion(jsonObject.getString("description"));
			...
			user.setAllow_all_act_msg(jsonObject
					.getBoolean("allow_all_act_msg"));
			...
			if (!jsonObject.isNull("status")) {
				user.setStatus(Status.getStatusByJSON(jsonObject
						.getJSONObject("status")));
			}
			user.setVerified_type(jsonObject.getInt("verified_type"));
			user.setAllow_all_comment(jsonObject
					.getBoolean("allow_all_comment"));
