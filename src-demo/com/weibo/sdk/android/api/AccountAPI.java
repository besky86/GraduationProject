...
public class AccountAPI extends WeiboAPI {
    ...
    public void getPrivacy(RequestListener listener) {
        ...
        super.request(SERVER_URL_PRIX + "/get_privacy.json", params, HTTPMETHOD_GET,
                listener);
    }
    ...
    public void schoolList(int province, int city, int area, SCHOOL_TYPE type,
        ...
        super.request(SERVER_URL_PRIX + "/profile/school_list.json", params,
    ...
    public void rateLimitStatus(RequestListener listener) {
        WeiboParameters params = new WeiboParameters();
        super.request(SERVER_URL_PRIX + "/rate_limit_status.json", params,
                HTTPMETHOD_GET, listener);
    }
    ...
    public void getUid(RequestListener listener) {
        WeiboParameters params = new WeiboParameters();
    //    params.add("access_token"  ,(WeiboAPI)this.r )
        //added   by Lei@2013/04/13 UPD START
        //super.request(SERVER_URL_PRIX + "/get_uid.json", params,  HTTPMETHOD_GET, listener);
        super.request(SERVER_URL_PRIX + "/get_uid.json", params,  HTTPMETHOD_GET, listener);
        //added   by Lei@2013/04/13 UPD END
        //delete by Lei@2013/04/13 DEL START
        //request(SERVER_URL_PRIX + "/get_uid.json", params, HTTPMETHOD_GET,
        //        listener);
        //delete by Lei@2013/04/13 DEL END
    }
    ...
    public void endSession(RequestListener listener) {
        WeiboParameters params = new WeiboParameters();
        super.request(SERVER_URL_PRIX + "/end_session.json", params, HTTPMETHOD_POST,
                listener);
    }
}
