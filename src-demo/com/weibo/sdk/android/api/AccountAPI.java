...
public class AccountAPI extends WeiboAPI {
	...
	public void getPrivacy(RequestListener listener) {
		...
		super.request(SERVER_URL_PRIX + "/get_privacy.json", params,
	...
	public void getUid(RequestListener listener) {
		...
		// super.request(SERVER_URL_PRIX + "/get_uid.json", params,
		// HTTPMETHOD_GET, listener);
		super.request(SERVER_URL_PRIX + "/get_uid.json", params,
				HTTPMETHOD_GET, listener);
	...
	public void endSession(RequestListener listener) {
		WeiboParameters params = new WeiboParameters();
		super.request(SERVER_URL_PRIX + "/end_session.json", params,
