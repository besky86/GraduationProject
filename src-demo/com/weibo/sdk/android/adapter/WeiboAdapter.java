	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (null == view) {
			...
			view = LayoutInflater.from(context).inflate(
					R.layout.wb_item_template, null);
			...
			holder.txt_wb_item_from.setText("来着:"
					+ Html.fromHtml(s.getSource()));
			...
			if (s.getRetweeted_status() != null) {
				...
				holder.txt_wb_item_subcontent.setText(s.getRetweeted_status()
						.getText());

				// 判断微博中是否含有图片
				if (!StringUtil.isEmpty(s.getRetweeted_status()
						.getThumbnail_pic())) {
